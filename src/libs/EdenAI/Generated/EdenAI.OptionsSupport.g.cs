...
namespace EdenAI
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::EdenAI.AutoSDKRetryOptions Retry { get; set; } = new global::EdenAI.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::EdenAI.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::EdenAI.IAutoSDKHook>();
        ...
        public global::EdenAI.AutoSDKClientOptions AddHook(
            global::EdenAI.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::EdenAI.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::EdenAI.AutoSDKClientOptions UseAuthorizationProvider(
            global::EdenAI.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::EdenAI.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::EdenAI.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::EdenAI.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::EdenAI.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::EdenAI.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::EdenAI.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::EdenAI.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::EdenAI.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::EdenAI.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::EdenAI.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::EdenAI.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::EdenAI.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::EdenAI.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::EdenAI.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::EdenAI.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::EdenAI.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::EdenAI.AutoSDKClientOptions clientOptions,
            global::EdenAI.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::EdenAI.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::EdenAI.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::EdenAI.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::EdenAI.AutoSDKClientOptions clientOptions,
            global::System.Func<global::EdenAI.IAutoSDKHook, global::EdenAI.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::EdenAI.AutoSDKHookContext context)
        {
