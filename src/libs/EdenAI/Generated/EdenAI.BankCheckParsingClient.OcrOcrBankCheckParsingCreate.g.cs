...
namespace EdenAI
{
    public partial class BankCheckParsingClient
    {


        private static readonly global::EdenAI.EndPointSecurityRequirement s_OcrOcrBankCheckParsingCreateSecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_OcrOcrBankCheckParsingCreateSecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_OcrOcrBankCheckParsingCreateSecurityRequirement0,
            };
        partial void PrepareOcrOcrBankCheckParsingCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::EdenAI.OcrbankCheckParsingBankCheckParsingRequest request);
        partial void PrepareOcrOcrBankCheckParsingCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::EdenAI.OcrbankCheckParsingBankCheckParsingRequest request);
        partial void ProcessOcrOcrBankCheckParsingCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessOcrOcrBankCheckParsingCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Bank Check Parsing<br/>
        /// &lt;details&gt;&lt;summary&gt;&lt;strong style='color: #0072a3; cursor: pointer'&gt;Available Providers&lt;/strong&gt;&lt;/summary&gt;<br/>
        /// |Provider|Version|Price|Billing unit|<br/>
        /// |----|-------|-----|------------|<br/>
        /// |**base64**|`latest`|0.25 (per 1 page)|1 page<br/>
        /// |**veryfi**|`v8`|0.16 (per 1 request)|1 request<br/>
        /// |**mindee**|`v1`|0.1 (per 1 page)|1 page<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.OcrbankCheckParsingResponseModel> OcrOcrBankCheckParsingCreateAsync(

            global::EdenAI.OcrbankCheckParsingBankCheckParsingRequest request,
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await OcrOcrBankCheckParsingCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.OcrbankCheckParsingResponseModel>> OcrOcrBankCheckParsingCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareOcrOcrBankCheckParsingCreateArguments(
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_OcrOcrBankCheckParsingCreateSecurityRequirements,
                operationName: "OcrOcrBankCheckParsingCreateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareOcrOcrBankCheckParsingCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "OcrOcrBankCheckParsingCreate",
                                methodName: "OcrOcrBankCheckParsingCreateAsync",
                                pathTemplate: "\"/ocr/bank_check_parsing/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessOcrOcrBankCheckParsingCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessOcrOcrBankCheckParsingCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::EdenAI.OcrbankCheckParsingResponseModel.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::EdenAI.AutoSDKHttpResponse<global::EdenAI.OcrbankCheckParsingResponseModel>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::EdenAI.OcrbankCheckParsingResponseModel.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await OcrOcrBankCheckParsingCreateAsync(
                request: __request,
                requestOptions: requestOptions,
