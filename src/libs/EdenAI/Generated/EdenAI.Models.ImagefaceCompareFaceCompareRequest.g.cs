...
namespace EdenAI
{
    ...
    public sealed partial class ImagefaceCompareFaceCompareRequest
    {
        ...
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("file1")]
        public byte[]? File1 { get; set; }

        /// <summary>
        /// File to analyse in binary format to be used with *content-type*: **multipart/form-data**  **Does not work with application/json !**
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("file1name")]
        public string? File1name { get; set; }

        /// <summary>
        /// File **URL** to analyse to be used with with *content-type*: **application/json**.
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("file1_url")]
        public string? File1Url { get; set; }

        /// <summary>
        /// File to analyse in binary format to be used with *content-type*: **multipart/form-data**  **Does not work with application/json !**
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("file2")]
        public byte[]? File2 { get; set; }

        /// <summary>
        /// File to analyse in binary format to be used with *content-type*: **multipart/form-data**  **Does not work with application/json !**
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("file2name")]
        public string? File2name { get; set; }

        /// <summary>
        /// File **URL** to analyse to be used with with *content-type*: **application/json**.
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("file2_url")]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImagefaceCompareFaceCompareRequest" /> class.
        /// </summary>
...
#endif
        public ImagefaceCompareFaceCompareRequest(
