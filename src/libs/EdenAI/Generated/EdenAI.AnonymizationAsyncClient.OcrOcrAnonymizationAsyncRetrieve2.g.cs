...
namespace EdenAI
{
    public partial class AnonymizationAsyncClient
    {
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_OcrOcrAnonymizationAsyncRetrieve2SecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_OcrOcrAnonymizationAsyncRetrieve2SecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_OcrOcrAnonymizationAsyncRetrieve2SecurityRequirement0,
            };
        partial void PrepareOcrOcrAnonymizationAsyncRetrieve2Arguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string publicId,
            ref bool? responseAsDict,
            ref bool? showBase64,
            ref bool? showOriginalResponse);
        partial void PrepareOcrOcrAnonymizationAsyncRetrieve2Request(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessOcrOcrAnonymizationAsyncRetrieve2Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessOcrOcrAnonymizationAsyncRetrieve2ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Anonymization Get Job Results<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.AsyncocranonymizationAsyncResponseModel> OcrOcrAnonymizationAsyncRetrieve2Async(
            string publicId,
        ...
        {
            var __response = await OcrOcrAnonymizationAsyncRetrieve2AsResponseAsync(
                publicId: publicId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.AsyncocranonymizationAsyncResponseModel>> OcrOcrAnonymizationAsyncRetrieve2AsResponseAsync(
            string publicId,
            bool? responseAsDict = default,
            bool? showBase64 = default,
            bool? showOriginalResponse = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareOcrOcrAnonymizationAsyncRetrieve2Arguments(
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_OcrOcrAnonymizationAsyncRetrieve2SecurityRequirements,
                operationName: "OcrOcrAnonymizationAsyncRetrieve2Async");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::EdenAI.PathBuilder(
                                path: $"/ocr/anonymization_async/{publicId}/",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareOcrOcrAnonymizationAsyncRetrieve2Request(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "OcrOcrAnonymizationAsyncRetrieve2",
                                methodName: "OcrOcrAnonymizationAsyncRetrieve2Async",
                                pathTemplate: "$\"/ocr/anonymization_async/{publicId}/\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessOcrOcrAnonymizationAsyncRetrieve2Response(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessOcrOcrAnonymizationAsyncRetrieve2ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::EdenAI.AsyncocranonymizationAsyncResponseModel.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::EdenAI.AutoSDKHttpResponse<global::EdenAI.AsyncocranonymizationAsyncResponseModel>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::EdenAI.AsyncocranonymizationAsyncResponseModel.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
