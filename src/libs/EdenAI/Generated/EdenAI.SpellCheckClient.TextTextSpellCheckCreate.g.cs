            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::EdenAI.TextspellCheckResponseModel.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::EdenAI.TextspellCheckResponseModel.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
