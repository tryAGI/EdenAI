...
namespace EdenAI
{
    public partial class GenerationAsyncClient
    {
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_VideoVideoGenerationAsyncDestroySecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_VideoVideoGenerationAsyncDestroySecurityRequirement1 =
            new global::EdenAI.EndPointSecurityRequirement
            {
                Authorizations = new global::EdenAI.EndPointAuthorizationRequirement[]
                { 
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_VideoVideoGenerationAsyncDestroySecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_VideoVideoGenerationAsyncDestroySecurityRequirement0,
                s_VideoVideoGenerationAsyncDestroySecurityRequirement1,
            };
        partial void PrepareVideoVideoGenerationAsyncDestroyArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareVideoVideoGenerationAsyncDestroyRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessVideoVideoGenerationAsyncDestroyResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task VideoVideoGenerationAsyncDestroyAsync(
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await VideoVideoGenerationAsyncDestroyAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse> VideoVideoGenerationAsyncDestroyAsResponseAsync(
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareVideoVideoGenerationAsyncDestroyArguments(
                httpClient: HttpClient);


            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_VideoVideoGenerationAsyncDestroySecurityRequirements,
                operationName: "VideoVideoGenerationAsyncDestroyAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareVideoVideoGenerationAsyncDestroyRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "VideoVideoGenerationAsyncDestroy",
                                methodName: "VideoVideoGenerationAsyncDestroyAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessVideoVideoGenerationAsyncDestroyResponse(
                    httpClient: HttpClient,
