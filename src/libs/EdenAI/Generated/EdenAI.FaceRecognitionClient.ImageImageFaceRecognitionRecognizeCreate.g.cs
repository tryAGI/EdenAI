...
namespace EdenAI
{
    public partial class FaceRecognitionClient
    {
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_ImageImageFaceRecognitionRecognizeCreateSecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_ImageImageFaceRecognitionRecognizeCreateSecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_ImageImageFaceRecognitionRecognizeCreateSecurityRequirement0,
            };
        partial void PrepareImageImageFaceRecognitionRecognizeCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::EdenAI.ImagefaceRecognitionrecognizeFaceRecognitionDetectFaceRequest request);
        partial void PrepareImageImageFaceRecognitionRecognizeCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::EdenAI.ImagefaceRecognitionrecognizeFaceRecognitionDetectFaceRequest request);
        partial void ProcessImageImageFaceRecognitionRecognizeCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessImageImageFaceRecognitionRecognizeCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Face Recognition - Recognize Face<br/>
        /// &lt;details&gt;&lt;summary&gt;&lt;strong style='color: #0072a3; cursor: pointer'&gt;Available Providers&lt;/strong&gt;&lt;/summary&gt;<br/>
        /// |Provider|Version|Price|Billing unit|<br/>
        /// |----|-------|-----|------------|<br/>
        /// |**amazon**|`boto3 1.26.8`|1.0 (per 1000 file)|1 file<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.ImagefaceRecognitionResponseModel> ImageImageFaceRecognitionRecognizeCreateAsync(

            global::EdenAI.ImagefaceRecognitionrecognizeFaceRecognitionDetectFaceRequest request,
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ImageImageFaceRecognitionRecognizeCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.ImagefaceRecognitionResponseModel>> ImageImageFaceRecognitionRecognizeCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareImageImageFaceRecognitionRecognizeCreateArguments(
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ImageImageFaceRecognitionRecognizeCreateSecurityRequirements,
                operationName: "ImageImageFaceRecognitionRecognizeCreateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareImageImageFaceRecognitionRecognizeCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ImageImageFaceRecognitionRecognizeCreate",
                                methodName: "ImageImageFaceRecognitionRecognizeCreateAsync",
                                pathTemplate: "\"/image/face_recognition/recognize/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessImageImageFaceRecognitionRecognizeCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessImageImageFaceRecognitionRecognizeCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.ImagefaceRecognitionResponseModel> ImageImageFaceRecognitionRecognizeCreateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::EdenAI.ImagefaceRecognitionrecognizeFaceRecognitionDetectFaceRequest
            {
                Settings = settings,
                Providers = providers,
            ...
            return await ImageImageFaceRecognitionRecognizeCreateAsync(
                request: __request,
                requestOptions: requestOptions,
