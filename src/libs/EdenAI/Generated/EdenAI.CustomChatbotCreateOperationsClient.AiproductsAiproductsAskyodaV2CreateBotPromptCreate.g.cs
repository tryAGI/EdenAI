...
namespace EdenAI
{
    public partial class CustomChatbotCreateOperationsClient
    {
        ...
        {
            await AiproductsAiproductsAskyodaV2CreateBotPromptCreateAsResponseAsync(
                model: model,
                name: name,
                projectId: projectId,
                text: text,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse> AiproductsAiproductsAskyodaV2CreateBotPromptCreateAsResponseAsync(
            string model,
            string name,
            global::System.Guid projectId,
            string text,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AiproductsAiproductsAskyodaV2CreateBotPromptCreate",
                                methodName: "AiproductsAiproductsAskyodaV2CreateBotPromptCreateAsync",
                                pathTemplate: "$\"/aiproducts/askyoda/v2/{projectId}/create_bot_prompt/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
