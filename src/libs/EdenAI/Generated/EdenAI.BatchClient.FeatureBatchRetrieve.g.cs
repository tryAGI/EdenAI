...
namespace EdenAI
{
    public partial class BatchClient
    {
        ...
        partial void PrepareFeatureBatchRetrieveArguments(
            ...
            ref int? page,
            ref int? publicId,
            ref global::EdenAI.FeatureBatchRetrieveStatus? status,
            ref string subfeature);
        partial void PrepareFeatureBatchRetrieveRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? page,
            int? publicId,
            global::EdenAI.FeatureBatchRetrieveStatus? status,
            string subfeature);
        partial void ProcessFeatureBatchRetrieveResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessFeatureBatchRetrieveResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.PaginatedBatchResponse> FeatureBatchRetrieveAsync(
            string feature,
            string name,
            string subfeature,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "FeatureBatchRetrieve",
                                methodName: "FeatureBatchRetrieveAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessFeatureBatchRetrieveResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessFeatureBatchRetrieveResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
