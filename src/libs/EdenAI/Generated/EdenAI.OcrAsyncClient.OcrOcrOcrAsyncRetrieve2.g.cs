...
namespace EdenAI
{
    public partial class OcrAsyncClient
    {
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_OcrOcrOcrAsyncRetrieve2SecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_OcrOcrOcrAsyncRetrieve2SecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_OcrOcrOcrAsyncRetrieve2SecurityRequirement0,
            };
        partial void PrepareOcrOcrOcrAsyncRetrieve2Arguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string publicId,
            ref bool? responseAsDict,
            ref bool? showBase64,
            ref bool? showOriginalResponse);
        partial void PrepareOcrOcrOcrAsyncRetrieve2Request(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessOcrOcrOcrAsyncRetrieve2Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessOcrOcrOcrAsyncRetrieve2ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.AsyncocrocrAsyncResponseModel> OcrOcrOcrAsyncRetrieve2Async(
            string publicId,
        ...
        {
            var __response = await OcrOcrOcrAsyncRetrieve2AsResponseAsync(
                publicId: publicId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.AsyncocrocrAsyncResponseModel>> OcrOcrOcrAsyncRetrieve2AsResponseAsync(
            string publicId,
            bool? responseAsDict = default,
            bool? showBase64 = default,
            bool? showOriginalResponse = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareOcrOcrOcrAsyncRetrieve2Arguments(
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_OcrOcrOcrAsyncRetrieve2SecurityRequirements,
                operationName: "OcrOcrOcrAsyncRetrieve2Async");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareOcrOcrOcrAsyncRetrieve2Request(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "OcrOcrOcrAsyncRetrieve2",
                                methodName: "OcrOcrOcrAsyncRetrieve2Async",
                                pathTemplate: "$\"/ocr/ocr_async/{publicId}/\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessOcrOcrOcrAsyncRetrieve2Response(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessOcrOcrOcrAsyncRetrieve2ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::EdenAI.AsyncocrocrAsyncResponseModel.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::EdenAI.AutoSDKHttpResponse<global::EdenAI.AsyncocrocrAsyncResponseModel>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::EdenAI.AsyncocrocrAsyncResponseModel.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
