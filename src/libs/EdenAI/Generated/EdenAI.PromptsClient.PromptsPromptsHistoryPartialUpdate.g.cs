...
namespace EdenAI
{
    public partial class PromptsClient
    {
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_PromptsPromptsHistoryPartialUpdateSecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_PromptsPromptsHistoryPartialUpdateSecurityRequirement1 =
            new global::EdenAI.EndPointSecurityRequirement
            {
                Authorizations = new global::EdenAI.EndPointAuthorizationRequirement[]
                { 
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_PromptsPromptsHistoryPartialUpdateSecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_PromptsPromptsHistoryPartialUpdateSecurityRequirement0,
                s_PromptsPromptsHistoryPartialUpdateSecurityRequirement1,
            };
        partial void PreparePromptsPromptsHistoryPartialUpdateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int id,
            ref string name,
            global::EdenAI.PatchedPromptHistoryRequest request);
        partial void PreparePromptsPromptsHistoryPartialUpdateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int id,
            string name,
            global::EdenAI.PatchedPromptHistoryRequest request);
        partial void ProcessPromptsPromptsHistoryPartialUpdateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPromptsPromptsHistoryPartialUpdateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.PromptHistory> PromptsPromptsHistoryPartialUpdateAsync(
            int id,
            string name,
        ...
        {
            var __response = await PromptsPromptsHistoryPartialUpdateAsResponseAsync(
                id: id,
                name: name,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.PromptHistory>> PromptsPromptsHistoryPartialUpdateAsResponseAsync(
            int id,
            string name,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePromptsPromptsHistoryPartialUpdateArguments(
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PromptsPromptsHistoryPartialUpdateSecurityRequirements,
                operationName: "PromptsPromptsHistoryPartialUpdateAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PromptsPromptsHistoryPartialUpdate",
                                methodName: "PromptsPromptsHistoryPartialUpdateAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPromptsPromptsHistoryPartialUpdateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPromptsPromptsHistoryPartialUpdateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::EdenAI.PromptHistory.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::EdenAI.AutoSDKHttpResponse<global::EdenAI.PromptHistory>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::EdenAI.PromptHistory.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.PromptHistory> PromptsPromptsHistoryPartialUpdateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::EdenAI.PatchedPromptHistoryRequest
            {
                Text = text,
                Model = model,
                Params = @params,
            ...
            return await PromptsPromptsHistoryPartialUpdateAsync(
                id: id,
                name: name,
                request: __request,
                requestOptions: requestOptions,
