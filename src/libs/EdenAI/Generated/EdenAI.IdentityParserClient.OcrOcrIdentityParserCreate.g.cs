...
namespace EdenAI
{
    public partial class IdentityParserClient
    {


        private static readonly global::EdenAI.EndPointSecurityRequirement s_OcrOcrIdentityParserCreateSecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_OcrOcrIdentityParserCreateSecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_OcrOcrIdentityParserCreateSecurityRequirement0,
            };
        partial void PrepareOcrOcrIdentityParserCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::EdenAI.OcridentityParserIdentityParserRequest request);
        partial void PrepareOcrOcrIdentityParserCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::EdenAI.OcridentityParserIdentityParserRequest request);
        partial void ProcessOcrOcrIdentityParserCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessOcrOcrIdentityParserCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// |----|----|-------|-----|------------|<br/>
        /// |**amazon**|-|`boto3 (v1.15.18)`|0.025 (per 1 page)|1 page<br/>
        /// |**base64**|-|`latest`|0.2 (per 1 page)|1 page<br/>
        /// |**microsoft**|-|`rest API 4.0 (2024-02-29-preview)`|0.01 (per 1 page)|1 page<br/>
        /// |**mindee**|-|`v2`|0.1 (per 1 page)|1 page<br/>
        /// |**klippa**|-|`v1`|0.1 (per 1 file)|1 file<br/>
        /// |**affinda**|-|`v3`|0.07 (per 1 file)|1 file<br/>
        /// |**openai**|**gpt-4o**|`v1`|0.02 (per 1 page)|1 page<br/>
        /// &lt;/details&gt;<br/>
        ...
        /// &lt;/details&gt;&lt;a href='https://old-app.edenai.run/v2/models?technology=ocr-identity_parser' target='_blank' rel='noopener noreferrer' &gt;&lt;h4&gt;Supported Models&lt;/h4&gt;&lt;/a&gt;<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.OcridentityParserResponseModel> OcrOcrIdentityParserCreateAsync(

            global::EdenAI.OcridentityParserIdentityParserRequest request,
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await OcrOcrIdentityParserCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.OcridentityParserResponseModel>> OcrOcrIdentityParserCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareOcrOcrIdentityParserCreateArguments(
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_OcrOcrIdentityParserCreateSecurityRequirements,
                operationName: "OcrOcrIdentityParserCreateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (request.ConvertToPdf != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent((global::System.Convert.ToString(request.ConvertToPdf, global::System.Globalization.CultureInfo.InvariantCulture) ?? string.Empty).ToLowerInvariant()),
                                    name: "\"convert_to_pdf\"");
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareOcrOcrIdentityParserCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "OcrOcrIdentityParserCreate",
                                methodName: "OcrOcrIdentityParserCreateAsync",
                                pathTemplate: "\"/ocr/identity_parser/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessOcrOcrIdentityParserCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessOcrOcrIdentityParserCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::EdenAI.OcridentityParserResponseModel.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::EdenAI.AutoSDKHttpResponse<global::EdenAI.OcridentityParserResponseModel>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::EdenAI.OcridentityParserResponseModel.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.OcridentityParserResponseModel> OcrOcrIdentityParserCreateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::EdenAI.OcridentityParserIdentityParserRequest
            {
                Settings = settings,
                Providers = providers,
            ...
            return await OcrOcrIdentityParserCreateAsync(
                request: __request,
                requestOptions: requestOptions,
