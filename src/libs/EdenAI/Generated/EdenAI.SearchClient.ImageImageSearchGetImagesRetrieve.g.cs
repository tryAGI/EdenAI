...
namespace EdenAI
{
    public partial class SearchClient
    {
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_ImageImageSearchGetImagesRetrieveSecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_ImageImageSearchGetImagesRetrieveSecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_ImageImageSearchGetImagesRetrieveSecurityRequirement0,
            };
        partial void PrepareImageImageSearchGetImagesRetrieveArguments(
        ...
        partial void PrepareImageImageSearchGetImagesRetrieveRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessImageImageSearchGetImagesRetrieveResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessImageImageSearchGetImagesRetrieveResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.ImagesearchResponseModel> ImageImageSearchGetImagesRetrieveAsync(
            global::System.Collections.Generic.IList<string> providers,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ImageImageSearchGetImagesRetrieveSecurityRequirements,
                operationName: "ImageImageSearchGetImagesRetrieveAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareImageImageSearchGetImagesRetrieveRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ImageImageSearchGetImagesRetrieve",
                                methodName: "ImageImageSearchGetImagesRetrieveAsync",
                                pathTemplate: "\"/image/search/get_images/\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessImageImageSearchGetImagesRetrieveResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessImageImageSearchGetImagesRetrieveResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
