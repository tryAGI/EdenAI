...
namespace EdenAI
{
    public partial class SearchClient
    {
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_ImageImageSearchLaunchSimilarityCreateSecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_ImageImageSearchLaunchSimilarityCreateSecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_ImageImageSearchLaunchSimilarityCreateSecurityRequirement0,
            };
        partial void PrepareImageImageSearchLaunchSimilarityCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::EdenAI.ImagesearchlaunchSimilaritySearchImageRequest request);
        partial void PrepareImageImageSearchLaunchSimilarityCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::EdenAI.ImagesearchlaunchSimilaritySearchImageRequest request);
        partial void ProcessImageImageSearchLaunchSimilarityCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessImageImageSearchLaunchSimilarityCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// |**nyckel**|`v1.0.0`|1.0 (per 1000 file)|1 file<br/>
        /// &lt;/details&gt;
        /// </summary>
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.ImagesearchResponseModel> ImageImageSearchLaunchSimilarityCreateAsync(

            global::EdenAI.ImagesearchlaunchSimilaritySearchImageRequest request,
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ImageImageSearchLaunchSimilarityCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.ImagesearchResponseModel>> ImageImageSearchLaunchSimilarityCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareImageImageSearchLaunchSimilarityCreateArguments(
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ImageImageSearchLaunchSimilarityCreateSecurityRequirements,
                operationName: "ImageImageSearchLaunchSimilarityCreateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareImageImageSearchLaunchSimilarityCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ImageImageSearchLaunchSimilarityCreate",
                                methodName: "ImageImageSearchLaunchSimilarityCreateAsync",
                                pathTemplate: "\"/image/search/launch_similarity/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessImageImageSearchLaunchSimilarityCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessImageImageSearchLaunchSimilarityCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ImageImageSearchLaunchSimilarityCreateAsync(
                request: __request,
                requestOptions: requestOptions,
