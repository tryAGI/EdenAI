...
namespace EdenAI
{
    public partial class UserManagementClient
    {
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_UserUserCustomTokenPartialUpdateSecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_UserUserCustomTokenPartialUpdateSecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_UserUserCustomTokenPartialUpdateSecurityRequirement0,
            };
        partial void PrepareUserUserCustomTokenPartialUpdateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string name,
            global::EdenAI.PatchedCustomTokenUpdateRequest request);
        partial void PrepareUserUserCustomTokenPartialUpdateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string name,
            global::EdenAI.PatchedCustomTokenUpdateRequest request);
        partial void ProcessUserUserCustomTokenPartialUpdateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUserUserCustomTokenPartialUpdateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.CustomTokenUpdate> UserUserCustomTokenPartialUpdateAsync(
            string name,
        ...
        {
            var __response = await UserUserCustomTokenPartialUpdateAsResponseAsync(
                name: name,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.CustomTokenUpdate>> UserUserCustomTokenPartialUpdateAsResponseAsync(
            string name,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUserUserCustomTokenPartialUpdateArguments(
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UserUserCustomTokenPartialUpdateSecurityRequirements,
                operationName: "UserUserCustomTokenPartialUpdateAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UserUserCustomTokenPartialUpdate",
                                methodName: "UserUserCustomTokenPartialUpdateAsync",
                                pathTemplate: "$\"/user/custom_token/{name}/\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUserUserCustomTokenPartialUpdateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUserUserCustomTokenPartialUpdateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::EdenAI.CustomTokenUpdate.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::EdenAI.AutoSDKHttpResponse<global::EdenAI.CustomTokenUpdate>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::EdenAI.CustomTokenUpdate.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
