...
namespace EdenAI
{
    public partial class QuestionAnswerClient
    {


        private static readonly global::EdenAI.EndPointSecurityRequirement s_ImageImageQuestionAnswerCreateSecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_ImageImageQuestionAnswerCreateSecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_ImageImageQuestionAnswerCreateSecurityRequirement0,
            };
        partial void PrepareImageImageQuestionAnswerCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::EdenAI.ImagequestionAnswerQuestionAnswerRequest request);
        partial void PrepareImageImageQuestionAnswerCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::EdenAI.ImagequestionAnswerQuestionAnswerRequest request);
        partial void ProcessImageImageQuestionAnswerCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessImageImageQuestionAnswerCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.ImagequestionAnswerResponseModel> ImageImageQuestionAnswerCreateAsync(

            global::EdenAI.ImagequestionAnswerQuestionAnswerRequest request,
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ImageImageQuestionAnswerCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.ImagequestionAnswerResponseModel>> ImageImageQuestionAnswerCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareImageImageQuestionAnswerCreateArguments(
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ImageImageQuestionAnswerCreateSecurityRequirements,
                operationName: "ImageImageQuestionAnswerCreateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (request.Question != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.Question ?? string.Empty),
                                    name: "\"question\"");
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareImageImageQuestionAnswerCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ImageImageQuestionAnswerCreate",
                                methodName: "ImageImageQuestionAnswerCreateAsync",
                                pathTemplate: "\"/image/question_answer/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessImageImageQuestionAnswerCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessImageImageQuestionAnswerCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::EdenAI.ImagequestionAnswerResponseModel.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::EdenAI.AutoSDKHttpResponse<global::EdenAI.ImagequestionAnswerResponseModel>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::EdenAI.ImagequestionAnswerResponseModel.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ImageImageQuestionAnswerCreateAsync(
                request: __request,
                requestOptions: requestOptions,
