...
namespace EdenAI
{
    public partial class ResumeParserClient
    {


        private static readonly global::EdenAI.EndPointSecurityRequirement s_OcrOcrResumeParserCreateSecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_OcrOcrResumeParserCreateSecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_OcrOcrResumeParserCreateSecurityRequirement0,
            };
        partial void PrepareOcrOcrResumeParserCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::EdenAI.OcrresumeParserResumeParserRequest request);
        partial void PrepareOcrOcrResumeParserCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::EdenAI.OcrresumeParserResumeParserRequest request);
        partial void ProcessOcrOcrResumeParserCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessOcrOcrResumeParserCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// |**senseloaf**|-|`v3`|0.045 (per 1 file)|1 file<br/>
        /// |**extracta**|-|`v1`|0.1 (per 1 page)|1 page<br/>
        /// |**openai**|-|`v1.0`|0.04 (per 1 page)|1 page<br/>
        ...
        /// |**Chinese (Taiwan)**|`zh-tw`|<br/>
        /// &lt;/details&gt;&lt;a href='https://old-app.edenai.run/v2/models?technology=ocr-resume_parser' target='_blank' rel='noopener noreferrer' &gt;&lt;h4&gt;Supported Models&lt;/h4&gt;&lt;/a&gt;<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.OcrresumeParserResponseModel> OcrOcrResumeParserCreateAsync(

            global::EdenAI.OcrresumeParserResumeParserRequest request,
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await OcrOcrResumeParserCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.OcrresumeParserResponseModel>> OcrOcrResumeParserCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareOcrOcrResumeParserCreateArguments(
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_OcrOcrResumeParserCreateSecurityRequirements,
                operationName: "OcrOcrResumeParserCreateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareOcrOcrResumeParserCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "OcrOcrResumeParserCreate",
                                methodName: "OcrOcrResumeParserCreateAsync",
                                pathTemplate: "\"/ocr/resume_parser/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessOcrOcrResumeParserCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessOcrOcrResumeParserCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::EdenAI.OcrresumeParserResponseModel.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::EdenAI.AutoSDKHttpResponse<global::EdenAI.OcrresumeParserResponseModel>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::EdenAI.OcrresumeParserResponseModel.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.OcrresumeParserResponseModel> OcrOcrResumeParserCreateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::EdenAI.OcrresumeParserResumeParserRequest
            {
                Settings = settings,
                Providers = providers,
            ...
            return await OcrOcrResumeParserCreateAsync(
                request: __request,
                requestOptions: requestOptions,
