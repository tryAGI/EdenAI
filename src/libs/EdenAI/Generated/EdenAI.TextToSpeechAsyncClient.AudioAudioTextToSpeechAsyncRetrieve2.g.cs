...
namespace EdenAI
{
    public partial class TextToSpeechAsyncClient
    {
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_AudioAudioTextToSpeechAsyncRetrieve2SecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_AudioAudioTextToSpeechAsyncRetrieve2SecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_AudioAudioTextToSpeechAsyncRetrieve2SecurityRequirement0,
            };
        partial void PrepareAudioAudioTextToSpeechAsyncRetrieve2Arguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string publicId,
            ref bool? responseAsDict,
            ref bool? showBase64,
            ref bool? showOriginalResponse);
        partial void PrepareAudioAudioTextToSpeechAsyncRetrieve2Request(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessAudioAudioTextToSpeechAsyncRetrieve2Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAudioAudioTextToSpeechAsyncRetrieve2ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Text To Speech Get Job Results<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.AsyncaudiotextToSpeechAsyncResponseModel> AudioAudioTextToSpeechAsyncRetrieve2Async(
            string publicId,
        ...
        {
            var __response = await AudioAudioTextToSpeechAsyncRetrieve2AsResponseAsync(
                publicId: publicId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.AsyncaudiotextToSpeechAsyncResponseModel>> AudioAudioTextToSpeechAsyncRetrieve2AsResponseAsync(
            string publicId,
            bool? responseAsDict = default,
            bool? showBase64 = default,
            bool? showOriginalResponse = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAudioAudioTextToSpeechAsyncRetrieve2Arguments(
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AudioAudioTextToSpeechAsyncRetrieve2SecurityRequirements,
                operationName: "AudioAudioTextToSpeechAsyncRetrieve2Async");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::EdenAI.PathBuilder(
                                path: $"/audio/text_to_speech_async/{publicId}/",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAudioAudioTextToSpeechAsyncRetrieve2Request(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AudioAudioTextToSpeechAsyncRetrieve2",
                                methodName: "AudioAudioTextToSpeechAsyncRetrieve2Async",
                                pathTemplate: "$\"/audio/text_to_speech_async/{publicId}/\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAudioAudioTextToSpeechAsyncRetrieve2Response(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAudioAudioTextToSpeechAsyncRetrieve2ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::EdenAI.AsyncaudiotextToSpeechAsyncResponseModel.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::EdenAI.AutoSDKHttpResponse<global::EdenAI.AsyncaudiotextToSpeechAsyncResponseModel>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::EdenAI.AsyncaudiotextToSpeechAsyncResponseModel.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
