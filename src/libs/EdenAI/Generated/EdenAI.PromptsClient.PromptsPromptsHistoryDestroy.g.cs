...
namespace EdenAI
{
    public partial class PromptsClient
    {
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_PromptsPromptsHistoryDestroySecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_PromptsPromptsHistoryDestroySecurityRequirement1 =
            new global::EdenAI.EndPointSecurityRequirement
            {
                Authorizations = new global::EdenAI.EndPointAuthorizationRequirement[]
                { 
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_PromptsPromptsHistoryDestroySecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_PromptsPromptsHistoryDestroySecurityRequirement0,
                s_PromptsPromptsHistoryDestroySecurityRequirement1,
            };
        partial void PreparePromptsPromptsHistoryDestroyArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int id,
            ref string name);
        partial void PreparePromptsPromptsHistoryDestroyRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int id,
            string name);
        partial void ProcessPromptsPromptsHistoryDestroyResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task PromptsPromptsHistoryDestroyAsync(
            int id,
            string name,
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await PromptsPromptsHistoryDestroyAsResponseAsync(
                id: id,
                name: name,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse> PromptsPromptsHistoryDestroyAsResponseAsync(
            int id,
            string name,
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PreparePromptsPromptsHistoryDestroyArguments(
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PromptsPromptsHistoryDestroySecurityRequirements,
                operationName: "PromptsPromptsHistoryDestroyAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePromptsPromptsHistoryDestroyRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PromptsPromptsHistoryDestroy",
                                methodName: "PromptsPromptsHistoryDestroyAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPromptsPromptsHistoryDestroyResponse(
                    httpClient: HttpClient,
