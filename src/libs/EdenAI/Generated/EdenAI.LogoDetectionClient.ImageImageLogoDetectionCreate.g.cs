...
namespace EdenAI
{
    public partial class LogoDetectionClient
    {
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_ImageImageLogoDetectionCreateSecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_ImageImageLogoDetectionCreateSecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_ImageImageLogoDetectionCreateSecurityRequirement0,
            };
        ...
        /// |**api4ai**|**v2**|`v1.0.0`|0.25 (per 1000 file)|1 file<br/>
        ...
        {
            var __response = await ImageImageLogoDetectionCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.ImagelogoDetectionResponseModel>> ImageImageLogoDetectionCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ImageImageLogoDetectionCreateSecurityRequirements,
                operationName: "ImageImageLogoDetectionCreateAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ImageImageLogoDetectionCreate",
                                methodName: "ImageImageLogoDetectionCreateAsync",
                                pathTemplate: "\"/image/logo_detection/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::EdenAI.ImagelogoDetectionResponseModel.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::EdenAI.AutoSDKHttpResponse<global::EdenAI.ImagelogoDetectionResponseModel>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::EdenAI.ImagelogoDetectionResponseModel.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
