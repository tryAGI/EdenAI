...
namespace EdenAI
{
    public partial class LabelDetectionAsyncClient
    {
        ...
        {
            var __response = await VideoVideoLabelDetectionAsyncRetrieveAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.ListAsyncJobResponse>> VideoVideoLabelDetectionAsyncRetrieveAsResponseAsync(
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
