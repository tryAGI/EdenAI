...
namespace EdenAI
{
    public partial class PromptsClient
    {
        ...
        partial void PreparePromptsPromptsHistoryListArguments(
            ...
            ref int? page,
            ref int? pageSize);
        partial void PreparePromptsPromptsHistoryListRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string name,
            int? page,
            int? pageSize);
        partial void ProcessPromptsPromptsHistoryListResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPromptsPromptsHistoryListResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.PaginatedPromptHistoryList> PromptsPromptsHistoryListAsync(
            string name,
            int? page = default,
        ...
        {
            var __response = await PromptsPromptsHistoryListAsResponseAsync(
                name: name,
                page: page,
                pageSize: pageSize,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.PaginatedPromptHistoryList>> PromptsPromptsHistoryListAsResponseAsync(
            string name,
            int? page = default,
            int? pageSize = default,
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PreparePromptsPromptsHistoryListArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PromptsPromptsHistoryList",
                                methodName: "PromptsPromptsHistoryListAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPromptsPromptsHistoryListResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPromptsPromptsHistoryListResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::EdenAI.PaginatedPromptHistoryList.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::EdenAI.AutoSDKHttpResponse<global::EdenAI.PaginatedPromptHistoryList>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::EdenAI.PaginatedPromptHistoryList.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
