...
namespace EdenAI
{
    public partial interface ICustomChatbotInfoOperationsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::EdenAI.AIProject>>> AiproductsAiproductsListAsResponseAsync(
            string? projectType = default,
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
    }
