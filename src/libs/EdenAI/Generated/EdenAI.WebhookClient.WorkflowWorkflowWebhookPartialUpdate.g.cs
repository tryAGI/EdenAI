...
namespace EdenAI
{
    public partial class WebhookClient
    {
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_WorkflowWorkflowWebhookPartialUpdateSecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_WorkflowWorkflowWebhookPartialUpdateSecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_WorkflowWorkflowWebhookPartialUpdateSecurityRequirement0,
            };
        partial void PrepareWorkflowWorkflowWebhookPartialUpdateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid workflowId,
            global::EdenAI.PatchedWebhookParametersRequest request);
        partial void PrepareWorkflowWorkflowWebhookPartialUpdateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid workflowId,
            global::EdenAI.PatchedWebhookParametersRequest request);
        partial void ProcessWorkflowWorkflowWebhookPartialUpdateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessWorkflowWorkflowWebhookPartialUpdateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.WebhookParameters> WorkflowWorkflowWebhookPartialUpdateAsync(
            global::System.Guid workflowId,
        ...
        {
            var __response = await WorkflowWorkflowWebhookPartialUpdateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.WebhookParameters>> WorkflowWorkflowWebhookPartialUpdateAsResponseAsync(
            global::System.Guid workflowId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareWorkflowWorkflowWebhookPartialUpdateArguments(
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WorkflowWorkflowWebhookPartialUpdateSecurityRequirements,
                operationName: "WorkflowWorkflowWebhookPartialUpdateAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WorkflowWorkflowWebhookPartialUpdate",
                                methodName: "WorkflowWorkflowWebhookPartialUpdateAsync",
                                pathTemplate: "$\"/workflow/{workflowId}/webhook/\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWorkflowWorkflowWebhookPartialUpdateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWorkflowWorkflowWebhookPartialUpdateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::EdenAI.WebhookParameters.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::EdenAI.AutoSDKHttpResponse<global::EdenAI.WebhookParameters>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::EdenAI.WebhookParameters.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.WebhookParameters> WorkflowWorkflowWebhookPartialUpdateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::EdenAI.PatchedWebhookParametersRequest
            {
            ...
            return await WorkflowWorkflowWebhookPartialUpdateAsync(
                workflowId: workflowId,
                request: __request,
                requestOptions: requestOptions,
