...
namespace EdenAI
{
    ...
    public sealed partial class OcrresumeParserResumeParserDataClass
    {
        ...
        public required global::EdenAI.ResumeExtractedData ExtractedData { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OcrresumeParserResumeParserDataClass" /> class.
        /// </summary>
...
#endif
        public OcrresumeParserResumeParserDataClass(
            global::EdenAI.ResumeExtractedData extractedData,
            global::EdenAI.Status549Enum status,
            object? originalResponse)
        {
            this.ExtractedData = extractedData ?? throw new global::System.ArgumentNullException(nameof(extractedData));
