...
namespace EdenAI
{
    public partial class SearchClient
    {
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_ImageImageSearchUploadImageCreateSecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_ImageImageSearchUploadImageCreateSecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_ImageImageSearchUploadImageCreateSecurityRequirement0,
            };
        partial void PrepareImageImageSearchUploadImageCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::EdenAI.ImagesearchuploadImageUploadImageRequest request);
        partial void PrepareImageImageSearchUploadImageCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::EdenAI.ImagesearchuploadImageUploadImageRequest request);
        partial void ProcessImageImageSearchUploadImageCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessImageImageSearchUploadImageCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Search - Upload Phase<br/>
        /// &lt;details&gt;&lt;summary&gt;&lt;strong style='color: #0072a3; cursor: pointer'&gt;Available Providers&lt;/strong&gt;&lt;/summary&gt;<br/>
        /// |Provider|Version|Price|Billing unit|<br/>
        /// |----|-------|-----|------------|<br/>
        /// |**sentisight**|`v3.3.1`|0.75 (per 1000 file)|1 file<br/>
        /// |**nyckel**|`v1.0.0`|0.5 (per 1000 file)|1 file<br/>
        /// &lt;/details&gt;
        /// </summary>
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.ImagesearchResponseModel> ImageImageSearchUploadImageCreateAsync(

            global::EdenAI.ImagesearchuploadImageUploadImageRequest request,
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ImageImageSearchUploadImageCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.ImagesearchResponseModel>> ImageImageSearchUploadImageCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareImageImageSearchUploadImageCreateArguments(
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ImageImageSearchUploadImageCreateSecurityRequirements,
                operationName: "ImageImageSearchUploadImageCreateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            __httpRequestContent.Add(
                                content: new global::System.Net.Http.StringContent(request.ImageName ?? string.Empty),
                                name: "\"image_name\"");
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareImageImageSearchUploadImageCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ImageImageSearchUploadImageCreate",
                                methodName: "ImageImageSearchUploadImageCreateAsync",
                                pathTemplate: "\"/image/search/upload_image/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessImageImageSearchUploadImageCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessImageImageSearchUploadImageCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        /// The image name need to have the extension of the file.
        /// </param>
        /// <param name="requestOptions">Per-request overrides such as headers, query parameters, timeout, retries, and response buffering.</param>
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.ImagesearchResponseModel> ImageImageSearchUploadImageCreateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::EdenAI.ImagesearchuploadImageUploadImageRequest
            {
                Settings = settings,
                Providers = providers,
            ...
            return await ImageImageSearchUploadImageCreateAsync(
                request: __request,
                requestOptions: requestOptions,
