...
namespace EdenAI
{
    public partial class FaceDetectionClient
    {


        private static readonly global::EdenAI.EndPointSecurityRequirement s_ImageImageFaceDetectionCreateSecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_ImageImageFaceDetectionCreateSecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_ImageImageFaceDetectionCreateSecurityRequirement0,
            };
        partial void PrepareImageImageFaceDetectionCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::EdenAI.ImagefaceDetectionFaceDetectionRequest request);
        partial void PrepareImageImageFaceDetectionCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::EdenAI.ImagefaceDetectionFaceDetectionRequest request);
        partial void ProcessImageImageFaceDetectionCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessImageImageFaceDetectionCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// |**api4ai**|`v1.0.0`|0.75 (per 1000 file)|1 file<br/>
        /// &lt;/details&gt;
        /// </summary>
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.ImagefaceDetectionResponseModel> ImageImageFaceDetectionCreateAsync(

            global::EdenAI.ImagefaceDetectionFaceDetectionRequest request,
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ImageImageFaceDetectionCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.ImagefaceDetectionResponseModel>> ImageImageFaceDetectionCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareImageImageFaceDetectionCreateArguments(
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ImageImageFaceDetectionCreateSecurityRequirements,
                operationName: "ImageImageFaceDetectionCreateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareImageImageFaceDetectionCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ImageImageFaceDetectionCreate",
                                methodName: "ImageImageFaceDetectionCreateAsync",
                                pathTemplate: "\"/image/face_detection/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessImageImageFaceDetectionCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessImageImageFaceDetectionCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::EdenAI.ImagefaceDetectionResponseModel.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::EdenAI.AutoSDKHttpResponse<global::EdenAI.ImagefaceDetectionResponseModel>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::EdenAI.ImagefaceDetectionResponseModel.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.ImagefaceDetectionResponseModel> ImageImageFaceDetectionCreateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::EdenAI.ImagefaceDetectionFaceDetectionRequest
            {
                Settings = settings,
                Providers = providers,
            ...
            return await ImageImageFaceDetectionCreateAsync(
                request: __request,
                requestOptions: requestOptions,
