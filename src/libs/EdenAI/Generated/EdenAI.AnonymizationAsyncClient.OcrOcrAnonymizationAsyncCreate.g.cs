...
namespace EdenAI
{
    public partial class AnonymizationAsyncClient
    {
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_OcrOcrAnonymizationAsyncCreateSecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_OcrOcrAnonymizationAsyncCreateSecurityRequirement1 =
            new global::EdenAI.EndPointSecurityRequirement
            {
                Authorizations = new global::EdenAI.EndPointAuthorizationRequirement[]
                { 
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_OcrOcrAnonymizationAsyncCreateSecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_OcrOcrAnonymizationAsyncCreateSecurityRequirement0,
                s_OcrOcrAnonymizationAsyncCreateSecurityRequirement1,
            };
        partial void PrepareOcrOcrAnonymizationAsyncCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::EdenAI.AnonymizationAsyncRequest request);
        partial void PrepareOcrOcrAnonymizationAsyncCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::EdenAI.AnonymizationAsyncRequest request);
        partial void ProcessOcrOcrAnonymizationAsyncCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessOcrOcrAnonymizationAsyncCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Anonymization Launch Job<br/>
        /// &lt;details&gt;&lt;summary&gt;&lt;strong style='color: #0072a3; cursor: pointer'&gt;Available Providers&lt;/strong&gt;&lt;/summary&gt;<br/>
        /// |Provider|Version|Price|Billing unit|<br/>
        /// |----|-------|-----|------------|<br/>
        /// |**readyredact**|`v1`|0.05 (per 1 file)|1 file<br/>
        /// |**base64**|`v1`|0.25 (per 1 page)|1 page<br/>
        /// |**privateai**|`v3`|0.01 (per 1 page)|1 page<br/>
        /// &lt;/details&gt;
        /// </summary>
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.LaunchAsyncJobResponse> OcrOcrAnonymizationAsyncCreateAsync(

            global::EdenAI.AnonymizationAsyncRequest request,
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await OcrOcrAnonymizationAsyncCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.LaunchAsyncJobResponse>> OcrOcrAnonymizationAsyncCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareOcrOcrAnonymizationAsyncCreateArguments(
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_OcrOcrAnonymizationAsyncCreateSecurityRequirements,
                operationName: "OcrOcrAnonymizationAsyncCreateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareOcrOcrAnonymizationAsyncCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "OcrOcrAnonymizationAsyncCreate",
                                methodName: "OcrOcrAnonymizationAsyncCreateAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessOcrOcrAnonymizationAsyncCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessOcrOcrAnonymizationAsyncCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await OcrOcrAnonymizationAsyncCreateAsync(
                request: __request,
                requestOptions: requestOptions,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::EdenAI.AnonymizationAsyncRequest
            {
                Settings = settings,
                Providers = providers,
                FallbackProviders = fallbackProviders,
