...
namespace EdenAI
{
    public partial class FaceCompareClient
    {


        private static readonly global::EdenAI.EndPointSecurityRequirement s_ImageImageFaceCompareCreateSecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_ImageImageFaceCompareCreateSecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_ImageImageFaceCompareCreateSecurityRequirement0,
            };
        partial void PrepareImageImageFaceCompareCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::EdenAI.ImagefaceCompareFaceCompareRequest request);
        partial void PrepareImageImageFaceCompareCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::EdenAI.ImagefaceCompareFaceCompareRequest request);
        partial void ProcessImageImageFaceCompareCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessImageImageFaceCompareCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// |----|-------|-----|------------|<br/>
        /// |**base64**|`latest`|0.25 (per 1 request)|1 request<br/>
        /// |**facepp**|`v3`|2.0 (per 1000 request)|1 request<br/>
        /// |**amazon**|`boto3 (v1.15.18)`|1.0 (per 1000 request)|1 request<br/>
        /// &lt;/details&gt;
        /// </summary>
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.ImagefaceCompareResponseModel> ImageImageFaceCompareCreateAsync(

            global::EdenAI.ImagefaceCompareFaceCompareRequest request,
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ImageImageFaceCompareCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.ImagefaceCompareResponseModel>> ImageImageFaceCompareCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareImageImageFaceCompareCreateArguments(
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ImageImageFaceCompareCreateSecurityRequirements,
                operationName: "ImageImageFaceCompareCreateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (request.File1 != default)
                            {

                                var __contentFile1 = new global::System.Net.Http.ByteArrayContent(request.File1 ?? global::System.Array.Empty<byte>());
                                __contentFile1.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.File1name is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.File1name) ?? string.Empty).ToLowerInvariant() switch
                                        {
                                            ".aac" => "audio/aac",
                                            ".flac" => "audio/flac",
                                            ".gif" => "image/gif",
                                ...
                                __httpRequestContent.Add(
                                    ...
                                    name: "\"file1\"",
                                    fileName: request.File1name != null ? $"\"{request.File1name}\"" : string.Empty);
                            ...
                            if (request.File1Url != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.File1Url ?? string.Empty),
                                    name: "\"file1_url\"");

                            }
                            if (request.File2 != default)
                            {

                                var __contentFile2 = new global::System.Net.Http.ByteArrayContent(request.File2 ?? global::System.Array.Empty<byte>());
                                __contentFile2.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.File2name is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.File2name) ?? string.Empty).ToLowerInvariant() switch
                                        {
                                            ".aac" => "audio/aac",
                                            ".flac" => "audio/flac",
                                            ".gif" => "image/gif",
                                ...
                                __httpRequestContent.Add(
                                    ...
                                    name: "\"file2\"",
                                    fileName: request.File2name != null ? $"\"{request.File2name}\"" : string.Empty);
                                if (__contentFile2.Headers.ContentDisposition != null)
                                {
                                    __contentFile2.Headers.ContentDisposition.FileNameStar = null;
                                }

                            }
                            if (request.File2Url != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.File2Url ?? string.Empty),
                                    name: "\"file2_url\"");
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareImageImageFaceCompareCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ImageImageFaceCompareCreate",
                                methodName: "ImageImageFaceCompareCreateAsync",
                                pathTemplate: "\"/image/face_compare/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessImageImageFaceCompareCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessImageImageFaceCompareCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::EdenAI.ImagefaceCompareResponseModel.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::EdenAI.AutoSDKHttpResponse<global::EdenAI.ImagefaceCompareResponseModel>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::EdenAI.ImagefaceCompareResponseModel.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.ImagefaceCompareResponseModel> ImageImageFaceCompareCreateAsync(
            ...
            byte[]? file1 = default,
            string? file1name = default,
            string? file1Url = default,
            byte[]? file2 = default,
            string? file2name = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ImageImageFaceCompareCreateAsync(
                request: __request,
                requestOptions: requestOptions,
