...
namespace EdenAI
{
    public partial class PromptsClient
    {
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_PromptsPromptsUpdateSecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_PromptsPromptsUpdateSecurityRequirement1 =
            new global::EdenAI.EndPointSecurityRequirement
            {
                Authorizations = new global::EdenAI.EndPointAuthorizationRequirement[]
                { 
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_PromptsPromptsUpdateSecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_PromptsPromptsUpdateSecurityRequirement0,
                s_PromptsPromptsUpdateSecurityRequirement1,
            };
        partial void PreparePromptsPromptsUpdateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string name,
            global::EdenAI.PromptUpdateRequest request);
        partial void PreparePromptsPromptsUpdateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string name,
            global::EdenAI.PromptUpdateRequest request);
        partial void ProcessPromptsPromptsUpdateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPromptsPromptsUpdateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.PromptUpdate> PromptsPromptsUpdateAsync(
            string name,
        ...
        {
            var __response = await PromptsPromptsUpdateAsResponseAsync(
                name: name,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.PromptUpdate>> PromptsPromptsUpdateAsResponseAsync(
            string name,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePromptsPromptsUpdateArguments(
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PromptsPromptsUpdateSecurityRequirements,
                operationName: "PromptsPromptsUpdateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePromptsPromptsUpdateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PromptsPromptsUpdate",
                                methodName: "PromptsPromptsUpdateAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPromptsPromptsUpdateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPromptsPromptsUpdateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::EdenAI.PromptUpdate.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::EdenAI.AutoSDKHttpResponse<global::EdenAI.PromptUpdate>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::EdenAI.PromptUpdate.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await PromptsPromptsUpdateAsync(
                name: name,
                request: __request,
                requestOptions: requestOptions,
