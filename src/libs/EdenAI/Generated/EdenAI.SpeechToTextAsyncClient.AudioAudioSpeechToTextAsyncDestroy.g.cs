...
namespace EdenAI
{
    public partial class SpeechToTextAsyncClient
    {
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_AudioAudioSpeechToTextAsyncDestroySecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_AudioAudioSpeechToTextAsyncDestroySecurityRequirement1 =
            new global::EdenAI.EndPointSecurityRequirement
            {
                Authorizations = new global::EdenAI.EndPointAuthorizationRequirement[]
                { 
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_AudioAudioSpeechToTextAsyncDestroySecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_AudioAudioSpeechToTextAsyncDestroySecurityRequirement0,
                s_AudioAudioSpeechToTextAsyncDestroySecurityRequirement1,
            };
        partial void PrepareAudioAudioSpeechToTextAsyncDestroyArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareAudioAudioSpeechToTextAsyncDestroyRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessAudioAudioSpeechToTextAsyncDestroyResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        /// <summary>
        /// Speech to text delete Jobs<br/>
        ...
        public async global::System.Threading.Tasks.Task AudioAudioSpeechToTextAsyncDestroyAsync(
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await AudioAudioSpeechToTextAsyncDestroyAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse> AudioAudioSpeechToTextAsyncDestroyAsResponseAsync(
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAudioAudioSpeechToTextAsyncDestroyArguments(
                httpClient: HttpClient);


            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_AudioAudioSpeechToTextAsyncDestroySecurityRequirements,
                operationName: "AudioAudioSpeechToTextAsyncDestroyAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAudioAudioSpeechToTextAsyncDestroyRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AudioAudioSpeechToTextAsyncDestroy",
                                methodName: "AudioAudioSpeechToTextAsyncDestroyAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAudioAudioSpeechToTextAsyncDestroyResponse(
                    httpClient: HttpClient,
