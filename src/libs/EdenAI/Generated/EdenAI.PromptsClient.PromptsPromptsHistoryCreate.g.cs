...
namespace EdenAI
{
    public partial class PromptsClient
    {
        ...
        {
            var __response = await PromptsPromptsHistoryCreateAsResponseAsync(
                name: name,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.PromptHistory>> PromptsPromptsHistoryCreateAsResponseAsync(
            string name,
