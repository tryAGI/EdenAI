...
namespace EdenAI
{
    public partial class CustomDocumentParsingAsyncClient
    {
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_OcrOcrCustomDocumentParsingAsyncRetrieve2SecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_OcrOcrCustomDocumentParsingAsyncRetrieve2SecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_OcrOcrCustomDocumentParsingAsyncRetrieve2SecurityRequirement0,
            };
        partial void PrepareOcrOcrCustomDocumentParsingAsyncRetrieve2Arguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string publicId,
            ref bool? responseAsDict,
            ref bool? showBase64,
            ref bool? showOriginalResponse);
        partial void PrepareOcrOcrCustomDocumentParsingAsyncRetrieve2Request(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessOcrOcrCustomDocumentParsingAsyncRetrieve2Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessOcrOcrCustomDocumentParsingAsyncRetrieve2ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Custom Document Parsing Get Job Results<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.AsyncocrcustomDocumentParsingAsyncResponseModel> OcrOcrCustomDocumentParsingAsyncRetrieve2Async(
            string publicId,
        ...
        {
            var __response = await OcrOcrCustomDocumentParsingAsyncRetrieve2AsResponseAsync(
                publicId: publicId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.AsyncocrcustomDocumentParsingAsyncResponseModel>> OcrOcrCustomDocumentParsingAsyncRetrieve2AsResponseAsync(
            string publicId,
            bool? responseAsDict = default,
            bool? showBase64 = default,
            bool? showOriginalResponse = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareOcrOcrCustomDocumentParsingAsyncRetrieve2Arguments(
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_OcrOcrCustomDocumentParsingAsyncRetrieve2SecurityRequirements,
                operationName: "OcrOcrCustomDocumentParsingAsyncRetrieve2Async");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::EdenAI.PathBuilder(
                                path: $"/ocr/custom_document_parsing_async/{publicId}/",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareOcrOcrCustomDocumentParsingAsyncRetrieve2Request(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "OcrOcrCustomDocumentParsingAsyncRetrieve2",
                                methodName: "OcrOcrCustomDocumentParsingAsyncRetrieve2Async",
                                pathTemplate: "$\"/ocr/custom_document_parsing_async/{publicId}/\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessOcrOcrCustomDocumentParsingAsyncRetrieve2Response(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessOcrOcrCustomDocumentParsingAsyncRetrieve2ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::EdenAI.AsyncocrcustomDocumentParsingAsyncResponseModel.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::EdenAI.AutoSDKHttpResponse<global::EdenAI.AsyncocrcustomDocumentParsingAsyncResponseModel>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::EdenAI.AsyncocrcustomDocumentParsingAsyncResponseModel.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
