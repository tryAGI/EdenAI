...
namespace EdenAI
{
    public partial class CustomDocumentParsingAsyncClient
    {


        private static readonly global::EdenAI.EndPointSecurityRequirement s_OcrOcrCustomDocumentParsingAsyncCreateSecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_OcrOcrCustomDocumentParsingAsyncCreateSecurityRequirement1 =
            new global::EdenAI.EndPointSecurityRequirement
            {
                Authorizations = new global::EdenAI.EndPointAuthorizationRequirement[]
                { 
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_OcrOcrCustomDocumentParsingAsyncCreateSecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_OcrOcrCustomDocumentParsingAsyncCreateSecurityRequirement0,
                s_OcrOcrCustomDocumentParsingAsyncCreateSecurityRequirement1,
            };
        partial void PrepareOcrOcrCustomDocumentParsingAsyncCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::EdenAI.CustomDocumentParsingAsyncRequest request);
        partial void PrepareOcrOcrCustomDocumentParsingAsyncCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::EdenAI.CustomDocumentParsingAsyncRequest request);
        partial void ProcessOcrOcrCustomDocumentParsingAsyncCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessOcrOcrCustomDocumentParsingAsyncCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Custom Document Parsing Launch Job<br/>
        /// &lt;details&gt;&lt;summary&gt;&lt;strong style='color: #0072a3; cursor: pointer'&gt;Available Providers&lt;/strong&gt;&lt;/summary&gt;<br/>
        /// |Provider|Version|Price|Billing unit|<br/>
        /// |----|-------|-----|------------|<br/>
        /// |**amazon**|`boto3 1.26.8`|15.0 (per 1000 page)|1 page<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.LaunchAsyncJobResponse> OcrOcrCustomDocumentParsingAsyncCreateAsync(

            global::EdenAI.CustomDocumentParsingAsyncRequest request,
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await OcrOcrCustomDocumentParsingAsyncCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.LaunchAsyncJobResponse>> OcrOcrCustomDocumentParsingAsyncCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareOcrOcrCustomDocumentParsingAsyncCreateArguments(
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_OcrOcrCustomDocumentParsingAsyncCreateSecurityRequirements,
                operationName: "OcrOcrCustomDocumentParsingAsyncCreateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            __httpRequestContent.Add(
                                content: new global::System.Net.Http.StringContent(request.Queries ?? string.Empty),
                                name: "\"queries\"");
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareOcrOcrCustomDocumentParsingAsyncCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "OcrOcrCustomDocumentParsingAsyncCreate",
                                methodName: "OcrOcrCustomDocumentParsingAsyncCreateAsync",
                                pathTemplate: "\"/ocr/custom_document_parsing_async/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessOcrOcrCustomDocumentParsingAsyncCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessOcrOcrCustomDocumentParsingAsyncCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await OcrOcrCustomDocumentParsingAsyncCreateAsync(
                request: __request,
                requestOptions: requestOptions,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::EdenAI.CustomDocumentParsingAsyncRequest
            {
                Settings = settings,
                Providers = providers,
                FallbackProviders = fallbackProviders,
