                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (request.FilePassword != default)
                            {
                                ...
                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent($"{request.FilePassword}"),
                                    name: "\"file_password\"");
                            }
                            __httpRequestContent.Add(
                                content: new global::System.Net.Http.StringContent($"{request.Queries}"),
                                name: "\"queries\"");
                            if (request.ConvertToPdf != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent($"{request.ConvertToPdf}"),
                                    name: "\"convert_to_pdf\"");
                            }
