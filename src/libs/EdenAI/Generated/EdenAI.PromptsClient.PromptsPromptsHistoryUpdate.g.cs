...
namespace EdenAI
{
    public partial class PromptsClient
    {
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_PromptsPromptsHistoryUpdateSecurityRequirement0 =
        ...
        partial void PreparePromptsPromptsHistoryUpdateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int id,
            string name,
            global::EdenAI.PromptHistoryRequest request);
        partial void ProcessPromptsPromptsHistoryUpdateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPromptsPromptsHistoryUpdateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.PromptHistory> PromptsPromptsHistoryUpdateAsync(
            int id,
            string name,
        ...
        {
            var __response = await PromptsPromptsHistoryUpdateAsResponseAsync(
                id: id,
                name: name,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.PromptHistory>> PromptsPromptsHistoryUpdateAsResponseAsync(
            int id,
            string name,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePromptsPromptsHistoryUpdateArguments(
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PromptsPromptsHistoryUpdateSecurityRequirements,
                operationName: "PromptsPromptsHistoryUpdateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePromptsPromptsHistoryUpdateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PromptsPromptsHistoryUpdate",
                                methodName: "PromptsPromptsHistoryUpdateAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPromptsPromptsHistoryUpdateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPromptsPromptsHistoryUpdateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await PromptsPromptsHistoryUpdateAsync(
                id: id,
                name: name,
                request: __request,
                requestOptions: requestOptions,
