...
namespace EdenAI
{
    public partial interface IExecutionsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.PaginatedExecutionListList>> WorkflowWorkflowExecutionListAsResponseAsync(
            global::System.Guid workflowId,
            int? page = default,
            int? pageSize = default,
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
