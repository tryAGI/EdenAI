...
namespace EdenAI
{
    public partial class QuestionAnswerAsyncClient
    {
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_VideoVideoQuestionAnswerAsyncCreateSecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_VideoVideoQuestionAnswerAsyncCreateSecurityRequirement1 =
            new global::EdenAI.EndPointSecurityRequirement
            {
                Authorizations = new global::EdenAI.EndPointAuthorizationRequirement[]
                { 
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_VideoVideoQuestionAnswerAsyncCreateSecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_VideoVideoQuestionAnswerAsyncCreateSecurityRequirement0,
                s_VideoVideoQuestionAnswerAsyncCreateSecurityRequirement1,
            };
        partial void PrepareVideoVideoQuestionAnswerAsyncCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::EdenAI.QuestionAnswerAsyncRequest request);
        partial void PrepareVideoVideoQuestionAnswerAsyncCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::EdenAI.QuestionAnswerAsyncRequest request);
        partial void ProcessVideoVideoQuestionAnswerAsyncCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessVideoVideoQuestionAnswerAsyncCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.LaunchAsyncJobResponse> VideoVideoQuestionAnswerAsyncCreateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareVideoVideoQuestionAnswerAsyncCreateArguments(
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_VideoVideoQuestionAnswerAsyncCreateSecurityRequirements,
                operationName: "VideoVideoQuestionAnswerAsyncCreateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (request.MaxTokens != default)
                            {
                                ...
                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent($"{request.MaxTokens}"),
                                    name: "\"max_tokens\"");
                            }
                            __httpRequestContent.Add(
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareVideoVideoQuestionAnswerAsyncCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "VideoVideoQuestionAnswerAsyncCreate",
                                methodName: "VideoVideoQuestionAnswerAsyncCreateAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessVideoVideoQuestionAnswerAsyncCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessVideoVideoQuestionAnswerAsyncCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await VideoVideoQuestionAnswerAsyncCreateAsync(
                request: __request,
                requestOptions: requestOptions,
