...
namespace EdenAI
{
    public partial class BackgroundRemovalClient
    {


        private static readonly global::EdenAI.EndPointSecurityRequirement s_ImageImageBackgroundRemovalCreateSecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_ImageImageBackgroundRemovalCreateSecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_ImageImageBackgroundRemovalCreateSecurityRequirement0,
            };
        partial void PrepareImageImageBackgroundRemovalCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::EdenAI.ImagebackgroundRemovalBackgroundRemovalRequest request);
        partial void PrepareImageImageBackgroundRemovalCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::EdenAI.ImagebackgroundRemovalBackgroundRemovalRequest request);
        partial void ProcessImageImageBackgroundRemovalCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessImageImageBackgroundRemovalCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.ImagebackgroundRemovalResponseModel> ImageImageBackgroundRemovalCreateAsync(

            global::EdenAI.ImagebackgroundRemovalBackgroundRemovalRequest request,
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ImageImageBackgroundRemovalCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.ImagebackgroundRemovalResponseModel>> ImageImageBackgroundRemovalCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareImageImageBackgroundRemovalCreateArguments(
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ImageImageBackgroundRemovalCreateSecurityRequirements,
                operationName: "ImageImageBackgroundRemovalCreateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareImageImageBackgroundRemovalCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ImageImageBackgroundRemovalCreate",
                                methodName: "ImageImageBackgroundRemovalCreateAsync",
                                pathTemplate: "\"/image/background_removal/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessImageImageBackgroundRemovalCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessImageImageBackgroundRemovalCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::EdenAI.ImagebackgroundRemovalResponseModel.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::EdenAI.AutoSDKHttpResponse<global::EdenAI.ImagebackgroundRemovalResponseModel>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::EdenAI.ImagebackgroundRemovalResponseModel.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        /// Provider specific parameters<br/>
        /// Default Value: {}
        /// </param>
        /// <param name="requestOptions">Per-request overrides such as headers, query parameters, timeout, retries, and response buffering.</param>
        /// <param name="cancellationToken">The token to cancel the operation with</param>
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ImageImageBackgroundRemovalCreateAsync(
                request: __request,
                requestOptions: requestOptions,
