...
namespace EdenAI
{
    public partial class CustomChatbotUpdateOperationsClient
    {
        ...
        {
            await AiproductsAiproductsAskyodaV2PartialUpdateAsResponseAsync(
                model: model,
                name: name,
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse> AiproductsAiproductsAskyodaV2PartialUpdateAsResponseAsync(
            string model,
            string name,
            global::System.Guid projectId,
            string promptName,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AiproductsAiproductsAskyodaV2PartialUpdate",
                                methodName: "AiproductsAiproductsAskyodaV2PartialUpdateAsync",
                                pathTemplate: "$\"/aiproducts/askyoda/v2/{projectId}/{promptName}/\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
