...
namespace EdenAI
{
    public partial class QuestionAnswerClient
    {
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_VideoVideoQuestionAnswerCreateSecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_VideoVideoQuestionAnswerCreateSecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_VideoVideoQuestionAnswerCreateSecurityRequirement0,
            };
        partial void PrepareVideoVideoQuestionAnswerCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::EdenAI.VideoquestionAnswerQuestionAnswerRequest request);
        partial void PrepareVideoVideoQuestionAnswerCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::EdenAI.VideoquestionAnswerQuestionAnswerRequest request);
        partial void ProcessVideoVideoQuestionAnswerCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessVideoVideoQuestionAnswerCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.VideoquestionAnswerResponseModel> VideoVideoQuestionAnswerCreateAsync(

            global::EdenAI.VideoquestionAnswerQuestionAnswerRequest request,
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await VideoVideoQuestionAnswerCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.VideoquestionAnswerResponseModel>> VideoVideoQuestionAnswerCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareVideoVideoQuestionAnswerCreateArguments(
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_VideoVideoQuestionAnswerCreateSecurityRequirements,
                operationName: "VideoVideoQuestionAnswerCreateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareVideoVideoQuestionAnswerCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "VideoVideoQuestionAnswerCreate",
                                methodName: "VideoVideoQuestionAnswerCreateAsync",
                                pathTemplate: "\"/video/question_answer/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessVideoVideoQuestionAnswerCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessVideoVideoQuestionAnswerCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::EdenAI.VideoquestionAnswerResponseModel.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::EdenAI.AutoSDKHttpResponse<global::EdenAI.VideoquestionAnswerResponseModel>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::EdenAI.VideoquestionAnswerResponseModel.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.VideoquestionAnswerResponseModel> VideoVideoQuestionAnswerCreateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::EdenAI.VideoquestionAnswerQuestionAnswerRequest
            {
                Settings = settings,
                Providers = providers,
            ...
            return await VideoVideoQuestionAnswerCreateAsync(
                request: __request,
                requestOptions: requestOptions,
