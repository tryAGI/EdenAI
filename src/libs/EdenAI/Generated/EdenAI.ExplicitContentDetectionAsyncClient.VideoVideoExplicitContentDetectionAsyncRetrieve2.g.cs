...
namespace EdenAI
{
    public partial class ExplicitContentDetectionAsyncClient
    {
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_VideoVideoExplicitContentDetectionAsyncRetrieve2SecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_VideoVideoExplicitContentDetectionAsyncRetrieve2SecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_VideoVideoExplicitContentDetectionAsyncRetrieve2SecurityRequirement0,
            };
        partial void PrepareVideoVideoExplicitContentDetectionAsyncRetrieve2Arguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string publicId,
            ref bool? responseAsDict,
            ref bool? showBase64,
            ref bool? showOriginalResponse);
        partial void PrepareVideoVideoExplicitContentDetectionAsyncRetrieve2Request(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessVideoVideoExplicitContentDetectionAsyncRetrieve2Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessVideoVideoExplicitContentDetectionAsyncRetrieve2ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.AsyncvideoexplicitContentDetectionAsyncResponseModel> VideoVideoExplicitContentDetectionAsyncRetrieve2Async(
            string publicId,
        ...
        {
            var __response = await VideoVideoExplicitContentDetectionAsyncRetrieve2AsResponseAsync(
                publicId: publicId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.AsyncvideoexplicitContentDetectionAsyncResponseModel>> VideoVideoExplicitContentDetectionAsyncRetrieve2AsResponseAsync(
            string publicId,
            bool? responseAsDict = default,
            bool? showBase64 = default,
            bool? showOriginalResponse = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareVideoVideoExplicitContentDetectionAsyncRetrieve2Arguments(
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_VideoVideoExplicitContentDetectionAsyncRetrieve2SecurityRequirements,
                operationName: "VideoVideoExplicitContentDetectionAsyncRetrieve2Async");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::EdenAI.PathBuilder(
                                path: $"/video/explicit_content_detection_async/{publicId}/",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareVideoVideoExplicitContentDetectionAsyncRetrieve2Request(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "VideoVideoExplicitContentDetectionAsyncRetrieve2",
                                methodName: "VideoVideoExplicitContentDetectionAsyncRetrieve2Async",
                                pathTemplate: "$\"/video/explicit_content_detection_async/{publicId}/\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessVideoVideoExplicitContentDetectionAsyncRetrieve2Response(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessVideoVideoExplicitContentDetectionAsyncRetrieve2ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::EdenAI.AsyncvideoexplicitContentDetectionAsyncResponseModel.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::EdenAI.AutoSDKHttpResponse<global::EdenAI.AsyncvideoexplicitContentDetectionAsyncResponseModel>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::EdenAI.AsyncvideoexplicitContentDetectionAsyncResponseModel.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
