...
namespace EdenAI
{
    public partial interface ICustomChatbotInfoOperationsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.AiProductFile>> AiproductsAiproductsAskyodaV2FilesRetrieveAsResponseAsync(
            global::System.Guid fileId,
            global::System.Guid projectId,
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
