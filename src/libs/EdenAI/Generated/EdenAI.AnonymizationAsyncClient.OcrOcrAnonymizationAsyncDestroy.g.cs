...
namespace EdenAI
{
    public partial class AnonymizationAsyncClient
    {
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_OcrOcrAnonymizationAsyncDestroySecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_OcrOcrAnonymizationAsyncDestroySecurityRequirement1 =
            new global::EdenAI.EndPointSecurityRequirement
            {
                Authorizations = new global::EdenAI.EndPointAuthorizationRequirement[]
                { 
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_OcrOcrAnonymizationAsyncDestroySecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_OcrOcrAnonymizationAsyncDestroySecurityRequirement0,
                s_OcrOcrAnonymizationAsyncDestroySecurityRequirement1,
            };
        partial void PrepareOcrOcrAnonymizationAsyncDestroyArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareOcrOcrAnonymizationAsyncDestroyRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessOcrOcrAnonymizationAsyncDestroyResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        /// <summary>
        /// Anonymization delete Jobs<br/>
        ...
        public async global::System.Threading.Tasks.Task OcrOcrAnonymizationAsyncDestroyAsync(
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await OcrOcrAnonymizationAsyncDestroyAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse> OcrOcrAnonymizationAsyncDestroyAsResponseAsync(
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareOcrOcrAnonymizationAsyncDestroyArguments(
                httpClient: HttpClient);


            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_OcrOcrAnonymizationAsyncDestroySecurityRequirements,
                operationName: "OcrOcrAnonymizationAsyncDestroyAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareOcrOcrAnonymizationAsyncDestroyRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "OcrOcrAnonymizationAsyncDestroy",
                                methodName: "OcrOcrAnonymizationAsyncDestroyAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessOcrOcrAnonymizationAsyncDestroyResponse(
                    httpClient: HttpClient,
