...
namespace EdenAI
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::EdenAI.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::EdenAI.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::EdenAI.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::EdenAI.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::EdenAI.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::EdenAI.ApiException exception)
        ...
        private static global::EdenAI.AutoSDKRequestOptions CloneRequestOptions(
            global::EdenAI.AutoSDKRequestOptions? source)
        {
            var clone = new global::EdenAI.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }
