...
namespace EdenAI
{
    public partial class CustomChatbotUploadOperationsClient
    {
        ...
        {
            await AiproductsAiproductsAskyodaV2AddUrlCreateAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse> AiproductsAiproductsAskyodaV2AddUrlCreateAsResponseAsync(
            global::System.Guid projectId,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AiproductsAiproductsAskyodaV2AddUrlCreate",
                                methodName: "AiproductsAiproductsAskyodaV2AddUrlCreateAsync",
                                pathTemplate: "$\"/aiproducts/askyoda/v2/{projectId}/add_url/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
