...
namespace EdenAI
{
    public partial class CustomChatbotUploadOperationsClient
    {
        ...
        {
            await AiproductsAiproductsAskyodaV2AddFileCreateAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse> AiproductsAiproductsAskyodaV2AddFileCreateAsResponseAsync(
            global::System.Guid projectId,
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (request.Provider != default)
                            {
                                ...
                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.Provider ?? string.Empty),
                                    name: "\"provider\"");
