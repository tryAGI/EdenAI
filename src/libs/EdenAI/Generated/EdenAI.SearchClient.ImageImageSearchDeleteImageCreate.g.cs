...
namespace EdenAI
{
    public partial class SearchClient
    {
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_ImageImageSearchDeleteImageCreateSecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_ImageImageSearchDeleteImageCreateSecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_ImageImageSearchDeleteImageCreateSecurityRequirement0,
            };
        partial void PrepareImageImageSearchDeleteImageCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::EdenAI.ImagesearchdeleteImageDeleteImageRequest request);
        partial void PrepareImageImageSearchDeleteImageCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::EdenAI.ImagesearchdeleteImageDeleteImageRequest request);
        partial void ProcessImageImageSearchDeleteImageCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessImageImageSearchDeleteImageCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.ImagesearchResponseModel> ImageImageSearchDeleteImageCreateAsync(

            global::EdenAI.ImagesearchdeleteImageDeleteImageRequest request,
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ImageImageSearchDeleteImageCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.ImagesearchResponseModel>> ImageImageSearchDeleteImageCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareImageImageSearchDeleteImageCreateArguments(
            ...
            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ImageImageSearchDeleteImageCreateSecurityRequirements,
                operationName: "ImageImageSearchDeleteImageCreateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareImageImageSearchDeleteImageCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ImageImageSearchDeleteImageCreate",
                                methodName: "ImageImageSearchDeleteImageCreateAsync",
                                pathTemplate: "\"/image/search/delete_image/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessImageImageSearchDeleteImageCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessImageImageSearchDeleteImageCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::EdenAI.ImagesearchResponseModel> ImageImageSearchDeleteImageCreateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::EdenAI.ImagesearchdeleteImageDeleteImageRequest
            {
                Settings = settings,
                Providers = providers,
            ...
            return await ImageImageSearchDeleteImageCreateAsync(
                request: __request,
                requestOptions: requestOptions,
