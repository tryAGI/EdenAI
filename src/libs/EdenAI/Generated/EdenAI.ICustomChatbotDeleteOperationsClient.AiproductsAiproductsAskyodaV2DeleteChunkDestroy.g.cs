...
namespace EdenAI
{
    public partial interface ICustomChatbotDeleteOperationsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse<global::EdenAI.YodaDeleteResponse>> AiproductsAiproductsAskyodaV2DeleteChunkDestroyAsResponseAsync(
            global::System.Guid projectId,
            global::System.Collections.Generic.IList<string>? chunkIds = default,
            string? id = default,
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
