...
namespace EdenAI
{
    public partial class PersonTrackingAsyncClient
    {
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_VideoVideoPersonTrackingAsyncDestroySecurityRequirement0 =
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement s_VideoVideoPersonTrackingAsyncDestroySecurityRequirement1 =
            new global::EdenAI.EndPointSecurityRequirement
            {
                Authorizations = new global::EdenAI.EndPointAuthorizationRequirement[]
                { 
        ...
        private static readonly global::EdenAI.EndPointSecurityRequirement[] s_VideoVideoPersonTrackingAsyncDestroySecurityRequirements =
            new global::EdenAI.EndPointSecurityRequirement[]
            {                s_VideoVideoPersonTrackingAsyncDestroySecurityRequirement0,
                s_VideoVideoPersonTrackingAsyncDestroySecurityRequirement1,
            };
        partial void PrepareVideoVideoPersonTrackingAsyncDestroyArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareVideoVideoPersonTrackingAsyncDestroyRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessVideoVideoPersonTrackingAsyncDestroyResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        /// <summary>
        /// Person Tracking delete Jobs<br/>
        ...
        public async global::System.Threading.Tasks.Task VideoVideoPersonTrackingAsyncDestroyAsync(
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await VideoVideoPersonTrackingAsyncDestroyAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EdenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EdenAI.AutoSDKHttpResponse> VideoVideoPersonTrackingAsyncDestroyAsResponseAsync(
            global::EdenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareVideoVideoPersonTrackingAsyncDestroyArguments(
                httpClient: HttpClient);


            var __authorizations = global::EdenAI.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_VideoVideoPersonTrackingAsyncDestroySecurityRequirements,
                operationName: "VideoVideoPersonTrackingAsyncDestroyAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareVideoVideoPersonTrackingAsyncDestroyRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EdenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EdenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "VideoVideoPersonTrackingAsyncDestroy",
                                methodName: "VideoVideoPersonTrackingAsyncDestroyAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessVideoVideoPersonTrackingAsyncDestroyResponse(
                    httpClient: HttpClient,
